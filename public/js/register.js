...
var KTCreateAccount = function () {
  ...
  var inputIndustria;
  var inputEstado;
  var inputAvatar; // Variables

  var stepperObj;
  var validations = [];
  var nombreLabel = document.querySelector('#inp_nombre label');
  var nombreInput = document.querySelector('#inp_nombre input[name="nombre"]');
  ...
  var initStepper = function initStepper() {
    ...
    stepperObj.on('kt.stepper.next', function (stepper) {
      ...
      document.getElementById("experticia").style.display = 'none'
      ...
      if (perfil == 'startup' || perfil == 'inversionista') {
        inputEstado.classList.remove('d-none');
      } else {
        inputEstado.classList.add('d-none');
      }
      if (perfil == 'expertos'){
        document.getElementById("experticia").style.display = 'block'

      }
      /* 
        startup :: startup;
        Inversionista :: firma;
        Centros de formacion :: inversionista;
        Expertos de industria :: expertos;
        Mentores :: Mentores;
  ...
  var handleForm = function handleForm() {
    formSubmitButton.addEventListener('click', function (e) {
      ...
      validator.validate().then( /*#__PURE__*/function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2(status) {
          var sendData;
  ...
  document.querySelectorAll("input[name='logo']").forEach(function (input) {
  ...
  return {
    ...
    init: function init() {
      ...
      //inputExperticia = document.getElementById('inp_experticia_id');      
